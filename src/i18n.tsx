...
const DICT: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    'desc.人物': '产业与科研背后的关键人物',
    'time.breakthroughs': '演进与突破',
    'timeline.focus': '当前聚焦范围：',
    'panel.related': '相关组件',
    'panel.role.series-member': '同系列',
    'panel.role.manufacturer': '制造方',
    'panel.role.manufacturer_inv': '相关产品',
    'panel.role.invested-in': '投资组合',
    'panel.role.invested-in_inv': '投资人',
    'panel.role.subsidiary-of': '隶属于',
    'panel.role.subsidiary-of_inv': '子公司',
    'panel.role.trained-on': '训练数据',
    'panel.role.trained-on_inv': '基于此训练的模型',
    'panel.role.tech-base': '技术依赖',
    'panel.role.tech-base_inv': '依赖此技术',
    'panel.role.deployed-at': '部署场景',
    'panel.role.deployed-at_inv': '部署中使用',
    'panel.role.customer-of': '客户',
    'panel.role.customer-of_inv': '供应商',
    'panel.role.supplier-to': '供应给',
    'panel.role.affiliated-with': '机构关联',
    'panel.role.competitor': '同类竞品',
    'panel.role.founder-of': '创立了',
    'panel.role.founder-of_inv': '创始人',
    'panel.role.employed-at': '任职于',
    'panel.role.employed-at_inv': '团队成员',
    'panel.role.alumni-of': '毕业于',
    'panel.role.alumni-of_inv': '校友',
    'panel.role.advised-by': '导师',
    'panel.role.advised-by_inv': '门生',
    'panel.role.related': '其他相关',
    'panel.evolution_timeline': '追踪演进脉络',
    'panel.system_link': '系统关联',
    'panel.visit': '访问官网',
    'panel.copy': '复制比对链接',
    'panel.no_compare': '此两条目暂无可对比的字段',
  ...
  en: {
    ...
    'desc.人物': 'Key people behind companies and research',
    'time.breakthroughs': 'Breakthroughs',
    'timeline.focus': 'Currently Focused On: ',
    'panel.related': 'Related Components',
    'panel.role.series-member': 'Same Series',
    'panel.role.manufacturer': 'Made By',
    'panel.role.manufacturer_inv': 'Their Products',
    'panel.role.invested-in': 'Portfolio',
    'panel.role.invested-in_inv': 'Investors',
    'panel.role.subsidiary-of': 'Subsidiary Of',
    'panel.role.subsidiary-of_inv': 'Subsidiaries',
    'panel.role.trained-on': 'Trained On',
    'panel.role.trained-on_inv': 'Models Trained On This',
    'panel.role.tech-base': 'Tech Base',
    'panel.role.tech-base_inv': 'Builds On This',
    'panel.role.deployed-at': 'Deployed At',
    'panel.role.deployed-at_inv': 'Deployments Use',
    'panel.role.customer-of': 'Customer Of',
    'panel.role.customer-of_inv': 'Customers',
    'panel.role.supplier-to': 'Supplies To',
    'panel.role.affiliated-with': 'Affiliated',
    'panel.role.competitor': 'Competitors',
    'panel.role.founder-of': 'Founded',
    'panel.role.founder-of_inv': 'Founders',
    'panel.role.employed-at': 'Works At',
    'panel.role.employed-at_inv': 'Team Members',
    'panel.role.alumni-of': 'Alumni Of',
    'panel.role.alumni-of_inv': 'Alumni',
    'panel.role.advised-by': 'Advisor',
    'panel.role.advised-by_inv': 'Advisees',
    'panel.role.related': 'Other Related',
    ...
    'panel.no_compare': 'No comparable fields between these two entries',
